...
it.skip("can sign / verify with Ed25519Signature2018", async () => {
  ...
  // security-v2 defines protected terms, and security-v3 attempts to redefine them.
  // this can only be resolved by upgrading the jsonld-signatures library to support
  // security-v3 or by only defining new terms in security-v3 (which we don't want to do).
